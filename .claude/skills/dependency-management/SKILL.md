...
Canonical source: `/memory/skills/dependency-management/SKILL.md`

Before using this skill, read the canonical source above and apply it
exactly. Do not create a second source of truth inside `.claude/skills/`.
